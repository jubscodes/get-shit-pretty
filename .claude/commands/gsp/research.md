...
1. Create chunks in `.design/research/exports/` following the structure defined in the `gsp-researcher` agent's `<chunked-exports>` section
2. Since research is the first phase, create `.design/exports/INDEX.md` by copying from `templates/exports-index.md` if it doesn't already exist
3. Replace the `<!-- BEGIN:research -->` … `<!-- END:research -->` section in INDEX.md with populated tables
